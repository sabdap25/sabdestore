...
TIMES="10"
CHATID="5340548062"
KEY="7031468609:AAG_Xe5HqhdwcwrP-OYX4-eMLdDGE4dSACc"
...
clear
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/Sabda25/sabdestoreizin/main/izin | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/Sabda25/sabdestoreizin/main/izin | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
...
Exp1=$(curl https://raw.githubusercontent.com/Sabda25/sabdestoreizin/main/izin | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/sabdap25/sabdestore/main/"
start=$(date +%s)
secs_to_human() {
...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/Sabda25/sabdestoreizin/main/izin | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/Sabda25/sabdestoreizin/main/izin | grep $ipsaya | awk '{print $3}')
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://t.me/sabdestore"},{"text":"Contack","url":"https://chat.whatsapp.com/ETAw4PGk23aHv7nu7sO8sF"}]]}'
...
wget raw.githubusercontent.com/sabdap25/sabdestore/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh
cd
